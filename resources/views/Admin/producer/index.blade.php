...
@section('title', 'Wecoder-It || Producer ')
@section('content')
<main>
    ...
    <div class="page-header">
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Producer Data </li>
        </ol>
...
<!-- Button trigger modal -->
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              @endif
              <form action="{{ route('addmissionproducers.allstore')}}" method="POST">
                  @csrf
                ...
                <div class="form-group">
                    ...
                    <textarea id="summernote" name="addmissiondetalis" col="60" row4="10"  style="border-color: aqua;"></textarea><br> 
    ...
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">Addmission Producer table</h4>
        <div class="row">
          <div class="col-12">
