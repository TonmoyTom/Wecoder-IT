...
@section('title', 'Wecoder-It| Banner Approve')
@section('content')
<main>
        ...
        <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Banner Approve</li>
              </ol>
            </nav>
          </div>
            ...
            <tbody>
                @php $count=0; @endphp
                  ...
                  <tr>
                    ...
                    <td style="text-align: center;">
                        @if($item->approve == 1)
                        <a href="javascript:void(0)" class=" updatebannerapprove" id="bannerApprove-{{$item->id }}"
                            section_id ="{{$item->id}}" >Active</a>
                        @else
                        <a href="javascript:void(0)" class=" updatebannerapprove" id="bannerApprove-{{$item->id }}"
                            section_id ="{{$item->id}}" >Deactive</a>
