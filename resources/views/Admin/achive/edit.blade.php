...
@section('title', 'Wecoder-It || Achive Edit')
@section('content')
    <main>
        <div class="contanier">
            <div class="row justify-content-center">
                <div class="col-lg-9">
                    <div class="card-body">
                        <h4 class="card-title" style="color: #000; margin-top:10px;">Achive Edit</h4>
                                ...
                                @endif
                                <form action="{{url('admin/achivement/edit/'.Crypt::encrypt($achive->id))}}" method="POST" enctype="multipart/form-data" >
                                    @csrf
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="slug" style="color: #000;" value="{{$achive->slug}}">
                                     <p style="color:red"> Ex: Achive_Trainner</p>
