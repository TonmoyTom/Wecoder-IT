...
@section('title', 'Wecoder-It || Counsell Edit')
@section('content')
    <main>
        <div class="contanier">
                ...
                <div class="col-lg-9">
                    <div class="card-body">
                        <h4 class="card-title" style="color: #000; margin-top:10px;">Mail Send</h4>
                                ...
                                <form action="{{url('admin/counsell/edit/'.Crypt::encrypt($categorys->id))}}" method="POST" >
                                    @csrf
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email" placeholder="Email "  value="{{$categorys->email}}">
                                  </div>
                                  <div class="form-group">
