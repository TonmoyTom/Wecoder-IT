...
@section('title', 'Wecoder-It || Leader ')
@section('content')
<main>
...
<!-- Button trigger modal -->
  @if(Auth::guard('admin')->user()->can('leaders.create'))
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Add Leaders</h5>
            ...
            <div class="modal-body">
              ...
              @endif
              <form action="{{ route('leaders.allstore')}}" method="POST" enctype="multipart/form-data">
                  @csrf
